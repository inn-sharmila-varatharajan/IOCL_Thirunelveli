<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/view/Admin.Master" CodeBehind="AnnunciatorReport.aspx.cs" Inherits="MonitoringSystem.view.AnnunciatorReport" %>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/2.3.5/jspdf.plugin.autotable.min.js"></script>
    <script>
        ...
        function GetItem(selecteddate, todate) {
            ...
            $.ajax({
                type: "POST",
                url: "AnnunciatorReport.aspx/getReport",
                ...
                if (list.length) {
                    ...
                    for (let cnt = 0; cnt < list.length; cnt++) {
                        ...
                        let row = `<tr>
                               <td>${cnt + 1}</td> <td>${obj.device}</td><td>${obj.date}</td>
                                <td>${obj.descr}</td >
                            </tr>`;
                        rowHTML += row;
                    }
