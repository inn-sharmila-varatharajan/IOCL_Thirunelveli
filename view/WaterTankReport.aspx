<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/view/Admin.Master" CodeBehind="WaterTankReport.aspx.cs" Inherits="MonitoringSystem.view.Water_Tank_Report" %>

<asp:Content ID="head" ContentPlaceHolderID="Content_Header" runat="server">
</asp:Content>
<asp:Content ID="WaterTankReport" ContentPlaceHolderID="Content_Page" runat="server">
     <div class="row mb-5 justify-content-center"">
            <div class="col-lg-9">
                <div class="card">
                    <h5 class="card-header fw-bolder iocl-blue-text">
                        FirePump Water-Level Report
                    </h5>  
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/2.3.5/jspdf.plugin.autotable.min.js"></script>
    <script>
        ...
        function GetItem(selecteddate, todate) {
            ...
            $.ajax({
                type: "POST",
                url: "WaterTankReport.aspx/getReport",
                ...
                if (list.length) {
                    ...
                    for (let cnt = 0; cnt < list.length; cnt++) {
                        ...
                        if (obj.device == 'Fire Water Tank2') {
                            var j = +list[0]['distance'] + +0.13;
                            p2 = j;
                        }
                        else
                            p2 = obj.distance;
