<%@ Page Language="C#" MasterPageFile="~/view/Admin.Master" AutoEventWireup="true" CodeBehind="Power.aspx.cs" Inherits="MonitoringSystem.view.Power" %>

<asp:Content ID="head" ContentPlaceHolderID="Content_Header" runat="server">
</asp:Content>
<asp:Content ID="Power_Parameters_Report" ContentPlaceHolderID="Content_Page" runat="server">
             <div class="row mb-5 justify-content-center"">
            <div class="col-lg-9">
                <div class="card">
                    <h5 class="card-header fw-bolder iocl-blue-text">
                       Power Parameter Report
                    </h5>
                    <div>  
    ...
    <script>
        ...
        function submit() {
            if (fromdate > todate) {
                ...
                alert("Please select below 30 days");
            }
            else {
                spinner.show();
        ...
        function GetItem(fromdate, todate) {

            $.ajax({
                type: "POST",
                url: "Power.aspx/getReport",
                ...
                if (list.length) {
                    ...
                    for (let cnt = 0; cnt < list.length; cnt++) {
                        ...
                        let row = `<tr>
                                <td>${obj.Device}</td><td>${obj.Phase}</td><td>${date[0]}</td>
