<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/view/Admin.Master" CodeBehind="DGMileageReport.aspx.cs" Inherits="MonitoringSystem.view.DGMileageReport" %>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/2.3.5/jspdf.plugin.autotable.min.js"></script>
    <script>
        ...
        function GetItem(selecteddate, todate) {
            ...
            $.ajax({
                type: "POST",
                url: "DGMileageReport.aspx/getReport",
                ...
                if (list.length) {
                    ...
                    for (let cnt = 0; cnt < list.length; cnt++) {
                        ...
                        let row = `<tr>
                               <td>${cnt + 1}</td> <td>${obj.device}</td><td>${obj.stime}</td>
                               <td>${obj.etime}</td >  <td>${obj.litres}</td >
                            </tr>`;
                        rowHTML += row;
                    }
