<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/view/Admin.Master" CodeBehind="Diesel.aspx.cs" Inherits="MonitoringSystem.view.Diesel" %>

<asp:Content ID="head" ContentPlaceHolderID="Content_Header" runat="server">
</asp:Content>
<asp:Content ID="DieselReoprt" ContentPlaceHolderID="Content_Page" runat="server">
     <div class="row mb-5 justify-content-center"">
            <div class="col-lg-9">
                <div class="card">
                    <h5 class="card-header fw-bolder iocl-blue-text">
                        Diesel-Top Up Report
                    </h5>  
                 ...
                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <table id="Table1" hidden  style="border: 1px solid black;border-collapse: collapse;" width="100%" align="center" cellpadding="2" cellspacing="2" border="0" bgcolor="#EAEAEA" >  
                            ...
                            <tr align="left" style="background-color:#004080;color:White;" >  
                                <td>Date</td>  
                                <td>Device</td>  
                                <td>Topup-Level from</td> 
                                <td>Topup-Level to</td> 
            ...
            $.ajax({
                ...
                if (list.length) {
                    ...
                    for (let cnt = 0; cnt < list.length; cnt++) {
                        let obj = list[cnt];
                        var p2;
                        let dateyt = obj.date1.split(" ");
                        var mydate = new Date(obj.date1);
                        var str = mydate.toString("yy-mm-dd");
                       // window.alert(str);
                        let row = `<tr>
                                <td>${dateyt[0]}</td><td>${obj.device}</td>
                                <td>${obj.min} mm</td > <td>${obj.max} mm</td >
                            </tr>`;
                        rowHTML += row;
                    }
