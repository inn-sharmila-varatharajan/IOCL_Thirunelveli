<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/view/Admin.Master" CodeBehind="FlowRate.aspx.cs" Inherits="MonitoringSystem.view.FlowRate" %>
            ...
            $.ajax({
                ...
                if (list.length) {
                    ...
                    for (let cnt = 0; cnt < list.length; cnt++) {
                        ...
                        let row = `<tr>
                                <td>${obj.date}</td><td>${obj.distance}</td>
                                <td>${obj.device}</td >
                            </tr>`;
                        rowHTML += row;
                    }
