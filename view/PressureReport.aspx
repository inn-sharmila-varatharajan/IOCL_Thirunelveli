<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/view/Admin.Master" CodeBehind="PressureReport.aspx.cs" Inherits="MonitoringSystem.view.PressureReport" %>

<asp:Content ID="head" ContentPlaceHolderID="Content_Header" runat="server">
</asp:Content>
<asp:Content ID="FlowReport" ContentPlaceHolderID="Content_Page" runat="server">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/2.3.5/jspdf.plugin.autotable.min.js"></script>
    <script>
        ...
        function GetItem(selecteddate, todate) {
            ...
            $.ajax({
                type: "POST",
                url: "PressureReport.aspx/getReport",
                ...
                if (list.length) {
                    ...
                    for (let cnt = 0; cnt < list.length; cnt++) {
                        let obj = list[cnt];
                        var day = obj.day.split(" ");

                        let row = `<tr>
                                <td>${day[0]}</td><td>${obj.hour}</td>
                                <td>${obj.voltage}</td >
                            </tr>`;
                        rowHTML += row;
                    }
